...
////metodo foreach che stampa gli ID dell'array////
  //todos.forEach(todo => console.log(todo.id));


////metodo map che stampa gli userId////
  const userId = todos.map((todos) => todos.userId);

  //console.log(userId);


////metodo filter che stampa gli ID dell'array i cui valori sono <= 4////

const filteredId = todos.filter((todoID) => todoID.id >= 4);
...
const todoList = [
    ...
    {
      id: 4,
      todo: 'Seguire la lezione',
      completed: true
    },

    {
      id: 5,
      todo: 'Preparare il pranzo',
      completed: true
    },
    ...
    {
      id: 8,
      todo: 'Fare benzina alla macchina',
      completed: false
    },
    {
      id: 9,
    ...
    {
      id: 12,
      todo: 'Avviare la lavatrice',
      completed: false
    },
    {
      id: 13,
      todo:'Pulire la cucina',
      completed: true
    },
    {
      id: 14,
    ...
    {
      id: 15,
      todo: 'Leggere qualcosa',
      completed: true
    },
    {
        id: 16,
        todo: 'Andare a dormire presto',
        completed: false
